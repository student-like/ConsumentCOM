...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void addDay(String dayTime) {
        ...
        values.put(BIER, 1); // Contact Name
        values.put(WEIN, 1); // Contact Phone
        values.put(OFEN, 1); // Contact Phone
        values.put(ZIGA, 1); // Contact Phone
        values.put(SHOT, 1); // Contact Phone
